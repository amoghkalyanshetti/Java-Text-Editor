...
public class TextEditor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("New File*", jScrollPane2);
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        //First check whether the file is saved or not
        if(jTabbedPane1.getTitleAt(data.getTabIndex()).endsWith("*"))//not saved
        {
            int option=JOptionPane.showConfirmDialog(this,"Save File");
            if(option==JOptionPane.NO_OPTION)//user does not want to save
            {
                this.dispose();//destroy the frame
            }
            else if(option==JOptionPane.OK_OPTION)//user wants to save
            {
                if(!data.isFileNameCreated())
                {
                    JFileChooser fileChooser = new JFileChooser();
